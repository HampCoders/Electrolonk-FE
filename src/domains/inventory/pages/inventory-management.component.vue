...
<script>
import {ElectricalComponent} from "@/domains/inventory/model/electrical-component.entity.js";
import {InventoryItem} from "@/domains/inventory/model/inventory.entity.js";
import {InventoryService} from "@/domains/inventory/services/inventory.service.js";
import {ElectricalComponentService} from "@/domains/inventory/services/electrical-component.service.js";
...
export default {
  ...
  mounted() {
    ...
    console.log("Inventories:", this.inventories);
    console.log('Tipo de inventories:', typeof this.inventories)
    console.log('Contenido de inventories:', this.inventories)
